...
| Cost estimate | Estimate hosting cost ranges. | completed | `.claude/CONNECT_SHOP_COST_ESTIMATE.md`, `docs/FINAL_PRODUCTION_COST_REVIEW.md` | Check current provider pricing manually. | Update ranges before quoting a client. |
...
| Client handover | Prepare admin/client documentation. | completed | `docs/ADMIN_GUIDE.md`, `docs/CLIENT_HANDOVER_CHECKLIST.md`, `docs/MAINTENANCE_AND_SUPPORT.md` | Customize for client. | Add screenshots or client-specific steps later. |
...
| Staging/launch testing | Provide a practical launch verification process. | partially completed | `docs/LAUNCH_CHECKLIST.md`, `project-docs/PRODUCTION_CHECKLIST.md` | Create/use a deployed staging environment. | Dedicated staging docs can still be added. |
...
| Cost review | Summarize final stack costs and risks. | completed | `docs/FINAL_PRODUCTION_COST_REVIEW.md` | Check provider pricing pages manually. | Recheck before quoting client. |
...
| Final Gemini review package | Give Gemini a clear independent review brief. | completed | `docs/FINAL_GEMINI_REVIEW_PACKAGE.md` | Run Gemini review and compare findings. | Fix any blockers Gemini finds. |
...
- Run the final Gemini review using `docs/FINAL_GEMINI_REVIEW_PACKAGE.md`.
